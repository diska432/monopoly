...
class Board:
    def __init__(self):
        self.board = [
            ...
            Shans(2),
            Company("Givenchy", 3, 60, "company", 4, 50, "brown"),
            Tax(4, 200),
            ...
            Company("Lufthansa", 21, 220, "company", 18, 150, "red"),
            Shans(22),
            Company("KLM", 23, 220, "company", 18, 150, "red"),
            Company("Scat", 24, 240, "company", 20, 150, "red"),
            Company("Ford", 25, 200, "car", 25),
            Company("Hardee's", 26, 260, "company", 22, 150, "yellow"),
            Company("Subway", 27, 260, "company", 24, 150, "yellow"),
